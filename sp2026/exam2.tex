...
Banzhaf power in $[12:8,6,4,2]$, power indices from marked pivots, and a city council
analyzed with coalition types.
\end{abstract}
\maketitle
...
\begin{prompt}
\textbf{(b)} Which players, if any, are dummies in this system?
...
\choice{C}
\choice{D}
\choice[correct]{None of them}
\end{selectAll}

\begin{feedback}
None. Every player is critical somewhere: even D, the lightest, is critical in
$\set{B,C,D}$, whose weight $12$ drops to $10$ without it.
\end{feedback}
\end{prompt}
