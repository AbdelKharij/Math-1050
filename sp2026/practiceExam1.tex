...
\begin{document}
\begin{abstract}
Practice for Exam 1, covering Chapter 1: the Condorcet criterion and Pairwise Comparisons,
...
For example, in the four-candidate schedule
\begin{center}
...
\end{tabular}
\end{center}
A and C tie for the most points, and A wins the tiebreak --- but A lost head-to-head to D,
$28$--$14$. A wins without being a Condorcet candidate.
\end{feedback}
\end{prompt}
\end{problem}
