...
\title{Homework 5: Banzhaf Power in a City Council}
\begin{document}
\begin{abstract}
A real weighted-voting system analyzed with coalition ``types'': a small city
...
A small city council consists of the mayor ($M$) and seven council members
...
Per the city's governing documents, the mayor has \emph{zero}
