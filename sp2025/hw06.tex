...
\title{Homework 6: Shapley-Shubik Power, Subsets, and Permutations}
\begin{document}
\begin{abstract}
...
\begin{problem}
A household regularly votes on things like where to eat using a weighted voting
system where each child has one vote, each adult has two
votes, and a simple majority is sufficient to make a decision.
