...
\title{Cumulative Final (Version B)}
\begin{document}
\begin{abstract}
...
\section*{Cumulative Final (Version B)}
...
\end{multipleChoice}
\begin{feedback}
First-place votes: D $11$, C $9$, B $5$, A $0$.
\end{feedback}
\end{prompt}
...
\end{multipleChoice}
\begin{feedback}
No majority ($13$). A ($0$) and then B ($5$) are eliminated; B's voters go to C (A is gone), giving C $14$, D $11$.
\end{feedback}
\end{prompt}
...
\end{multipleChoice}
\begin{feedback}
Borda points: D $76$, C $68$, A $57$, B $49$.
\end{feedback}
\end{prompt}
\end{problem}
...
\end{multipleChoice}
\begin{feedback}
C beats B $10$--$2$ and D $9$--$3$ and ties A: $2.5$. A beats B $9$--$3$ and ties C and D: $2$. D ties A and B: $1$. B ties D: $0.5$.
\end{feedback}
\end{prompt}
...
\end{multipleChoice}
\begin{feedback}
No: C, the Pairwise winner, only ties A.
\end{feedback}
\end{prompt}
\end{problem}

\begin{problem}
An election with four candidates and $40$ voters used a modified Borda count: $7,5,3,1$ points. A had $110$ points, B $90$, and C $250$. Questions 12--15 ask for the ranking.
...
\end{multipleChoice}
\begin{feedback}
Each ballot awards $16$ points, $640$ in all, so D has $640-450=190$: C $250$, D $190$, A $110$, B $90$.
\end{feedback}
\end{prompt}
\end{problem}

\begin{problem}
Questions 16--19 use the weighted voting system $[19:10,7,5,4]$.
...
\end{multipleChoice}
\begin{feedback}
No player's weight reaches the quota of $19$.
\end{feedback}
\end{prompt}
...
\begin{multipleChoice}
\choice{All players}
\choice[correct]{Only $P_1$}
\choice{Only $P_2$}
\choice{$P_1$ and $P_2$}
\choice{None of the players}
\end{multipleChoice}
\begin{feedback}
Without $P_1$: $16<19$; without $P_2$: $19\ge19$.
\end{feedback}
\end{prompt}
...
House & \$151,000 & \$175,000 & \$142,000\\
Farm & \$434,000 & \$428,000 & \$425,000
\end{tabular}
\end{center}
...
\begin{multipleChoice}
\choice{\$24,000}
\choice[correct]{\$8,000}
\choice{\$7,000}
\choice{There was no surplus}
\end{multipleChoice}
\begin{feedback}
Totals $585$, $603$, $567$ (thousands), so fair shares are $195$, $201$, $189$. Andre gets the farm ($434$) and owes $239$; Bea gets the house ($175$) and receives $26$; Chad receives $189$. Surplus $239-26-189=24$, or $8$ each.
\end{feedback}
\end{prompt}
...
\choice{Only \$195,000 cash}
\choice{The farm only}
\choice[correct]{The farm, and pays \$231,000}
\choice{The house and \$239,000}
\end{multipleChoice}
\end{prompt}
...
\begin{multipleChoice}
\choice{The house, and pays \$34,000}
\choice{Only \$224,000 cash}
\choice{The farm only}
\choice{The house and \$26,000}
\choice[correct]{The house and \$34,000}
\end{multipleChoice}
\end{prompt}
...
\choice{Only \$189,000 cash}
\choice{The house and some cash}
\choice[correct]{Only \$197,000 cash}
\choice{The house, and pays \$197,000}
\end{multipleChoice}
\begin{feedback}
Final: Andre pays $239-8=231$; Bea receives $26+8=34$; Chad receives $189+8=197$.
\end{feedback}
\end{prompt}
\end{problem}
...
\end{multipleChoice}
\begin{feedback}
T.V.: $-2.1p_1+1.2(1-p_1)=-3.3p_1+1.2$. Radio: $3p_1-1(1-p_1)=4p_1-1$.
\end{feedback}
\end{prompt}
...
\end{multipleChoice}
\begin{feedback}
No. The row minimums $-2.1,-1.0$ have maximum $-1.0$; the column maximums $1.2,3.0$ have minimum $1.2$. They differ, so there is no saddle point.
\end{feedback}
\end{prompt}
\end{problem}
