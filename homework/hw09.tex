...
\title{Homework 9: Apportionment --- Hamilton, Jefferson, Adams, Webster}
\begin{document}
\begin{abstract}
...
\begin{problem}
The residence halls at Iowa State University have the following population capacities,
totaling $6558$ students:

\begin{center}
\begin{tabular}{r|c|c|c|c|c|c}
\textbf{Hall} & Wallace & Wilson & Martin & Birch & Willow & Larch \\\hline
\textbf{Pop.} & 270 & 270 & 331 & 184 & 544 & 544 \\
\end{tabular}

\smallskip
\begin{tabular}{r|c|c|c|c|c|c}
\textbf{Hall} & Barton & Freeman & Roberts & Maple & Linden & Elm \\\hline
\textbf{Pop.} & 99 & 136 & 107 & 496 & 321 & 202 \\
\end{tabular}

\smallskip
\begin{tabular}{r|c|c|c|c|c}
\textbf{Hall} & Geoffroy & Oak & Lyon & Helser & Friley \\\hline
...
Friley: $\answer[tolerance=0.005]{40.93}$ \qquad
Geoffroy: $\answer[tolerance=0.005]{25.83}$ \qquad
Helser: $\answer[tolerance=0.005]{23.92}$

\smallskip
Willow: $\answer[tolerance=0.005]{18.25}$ \qquad
Maple: $\answer[tolerance=0.005]{16.64}$ \qquad
Barton: $\answer[tolerance=0.005]{3.32}$

\begin{feedback}
Dividing each population by $29.81$:
\[
\begin{array}{llll}
\text{Wallace } 9.06 & \text{Wilson } 9.06 & \text{Martin } 11.10 & \text{Birch } 6.17\\
\text{Willow } 18.25 & \text{Larch } 18.25 & \text{Barton } 3.32 & \text{Freeman } 4.56\\
\text{Roberts } 3.59 & \text{Maple } 16.64 & \text{Linden } 10.77 & \text{Elm } 6.78\\
\text{Geoffroy } 25.83 & \text{Oak } 7.88 & \text{Lyon } 3.89 & \text{Helser } 23.92\\
\text{Friley } 40.93 & & &
\end{array}
\]
...
\choice{Barton}
\choice{Freeman}
\choice[correct]{Roberts}
\choice[correct]{Maple}
\choice[correct]{Linden}
\choice[correct]{Elm}
\choice[correct]{Geoffroy}
\choice[correct]{Oak}
\choice[correct]{Lyon}
\choice[correct]{Helser}
\choice[correct]{Friley}
\end{selectAll}
...
\[
\begin{array}{lll}
\text{Friley } .927 & \text{Helser } .919 & \text{Lyon } .891\\
\text{Oak } .884 & \text{Geoffroy } .831 & \text{Elm } .776\\
\text{Linden } .769 & \text{Maple } .639 & \text{Roberts } .590\\
\end{array}
\]
Those are the top nine, so each of them gets one extra RA. The next in line is Freeman
at $.562$, which just misses.

The final Hamilton apportionment is:
\[
\begin{array}{llll}
\text{Wallace } 9 & \text{Wilson } 9 & \text{Martin } 11 & \text{Birch } 6\\
\text{Willow } 18 & \text{Larch } 18 & \text{Barton } 3 & \text{Freeman } 4\\
\text{Roberts } 4 & \text{Maple } 17 & \text{Linden } 11 & \text{Elm } 7\\
\text{Geoffroy } 26 & \text{Oak } 8 & \text{Lyon } 4 & \text{Helser } 24\\
\text{Friley } 41 & & &
\end{array}
\]
which totals $220$. \checkmark

Notice Roberts (population $107$) receives $4$ RAs while Freeman (population $136$)
receives only $4$ as well --- and Lyon, with just $116$ students, also gets $4$. Small
...
\end{array}
\]
Only Hamilton's method stays within the quota here --- but as Homework 10 shows,
